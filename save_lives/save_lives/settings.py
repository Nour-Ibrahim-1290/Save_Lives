"""
Django settings for save_lives project.
...
SECRET_KEY = 'django-insecure-+zm2t&6ox^c4xt($37didv&=udt8(b%%lnbqz3-t6k_*1$vj@r'
...
WSGI_APPLICATION = 'save_lives.wsgi.application'
...
# media urls
MEDIA_URL = '/img/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'frontend/public/img')
...
STATICFILES_DIRS = [
        ...
        os.path.join(BASE_DIR, 'frontend/public/css'),
        os.path.join(BASE_DIR, 'frontend/public/fonts'),
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'savelivesbuisness@gmail.com'
EMAIL_HOST_PASSWORD = 'mook ouhq yber yycf'
## Testing
